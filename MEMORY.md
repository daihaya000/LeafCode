...
### 謨呵ｨ・- 邨ｶ蟇ｾ驟咲ｽｮpopup繧貞性繧隕∫ｴ縺ｯ縲～overflow-x-auto` / `overflow-hidden` 縺ｮ隕ｪ縺ｫ蜈･繧後↑縺・よｨｪ繧ｹ繧ｯ繝ｭ繝ｼ繝ｫ縺悟ｿ・ｦ√↑繧峨√せ繧ｯ繝ｭ繝ｼ繝ｫ蟇ｾ雎｡縺ｮ謫堺ｽ懃ｾ､縺縺代ｒ蜀・・繧ｳ繝ｳ繝・リ縺ｫ蛻・屬縺吶ｋ縲・- ブラウザ/Playwright検証はユーザー指示で停止。型検査・lint・コンパイルで品質確認し、実機表示はユーザー側で確認する。
