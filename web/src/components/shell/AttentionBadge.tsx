...
export function AttentionBadge() {
  ...
  return (
    <button
      type="button"
      onClick={() => openNext()}
      className="inline-flex h-8 shrink-0 items-center justify-center rounded-lg hover:bg-surface-2 focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-primary"
